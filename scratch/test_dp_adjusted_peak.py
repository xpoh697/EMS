...
# Start at hour 17 (expensive hours)
status, schedule, _ = run_boiler_dp_adjusted(slots[17:], 45.0, 40.0, t_max_elec, t_max_gas, vol_elec, vol_gas, gas_cost_m3, cal_data, temp_reward=0.002)
print("Starting at Hour 17, temp = 45.0:")
for s in schedule:
